...
/**
 * ChooseRoom is used to present a listView for app-user to choose which
 * chatting room he/she wants to go in, be it public room, group chatting room
 * or friend chatting *
 */
	...
	public void onCreate() {
		...
		mListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				switch (position) {
				case 0:
					MainBodyActivity.getInstance().gotoPage(
							MainBodyActivity.mTabNumContacts,
