								...
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
										...
										FrdRequestEntity reqEnt0 = new FrdRequestEntity(
												new UserInfo(mThisItem
														.getStrOfUser()),
												ConnectedApp.getInstance()
														.getUserInfo());
										reqEnt0.accept();
										NetworkService
												.getInstance()
												.sendUpload(
														GlobalMsgTypes.msgFriendshipRequestResponse,
														reqEnt0.toString());

										mThisItem
												.setStatus(FrdReqNotifItemEntity.mAccepted);
										FrdRequestNotifActivity
												.getInstance()
												.setItemStatus(
														mThisPos,
														FrdReqNotifItemEntity.mAccepted);
						...
						.setPositiveButton("Yes",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
										...
										mThisItem
												.setStatus(FrdReqNotifItemEntity.mDeclined);
										FrdRequestNotifActivity
												.getInstance()
												.setItemStatus(
														mThisPos,
														FrdReqNotifItemEntity.mDeclined);
									}
								})
						.setNegativeButton("No",
								new DialogInterface.OnClickListener() {
