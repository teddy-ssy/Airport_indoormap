...
public class MapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SAILSMap_search_result = (FrameLayout) findViewById(R.id.SAILSMap);
		relativelayout_allitemofmap = (RelativeLayout) findViewById(R.id.relativelayout_allitemofmap2);
		RelativeLayout_result = (RelativeLayout) findViewById(R.id.RelativeLayout_result2);
		...
		cameraButton = (Button) findViewById(R.id.pinMarker);
		distanceView = (TextView) findViewById(R.id.distanceView);
		distanceView.setVisibility(View.INVISIBLE);
		distanceView.setBackgroundColor(Color.argb(0, 0, 0, 0));
		...
		currentFloorDistanceView.setBackgroundColor(Color.argb(0, 0, 0, 0));
		msgView = (TextView) findViewById(R.id.msgView);
		msgView.setVisibility(View.INVISIBLE);
		msgView.setBackgroundColor(Color.argb(0, 0, 0, 0));
		banner_unopen = (RelativeLayout) findViewById(R.id.banner_unopen);
		banner_unopen.setVisibility(View.INVISIBLE);
		banner_open = (RelativeLayout) findViewById(R.id.banner_open);
		...
		cameraButton.setOnClickListener(controlListener);
		...
		animation = AnimationUtils.loadAnimation(MapActivity.this,
				R.anim.bannershow);
		textview_open = (TextView) findViewById(R.id.textvire_open);
		textview_unopen = (TextView) findViewById(R.id.textvire_unopen);
		banner_open_settraget = (Button) findViewById(R.id.button_open_settraget);
		banner_open_settraget.setOnClickListener(controlListener);
		banner_open_settrainset = (Button) findViewById(R.id.button_open_settrainset);
		banner_open_settrainset.setOnClickListener(controlListener);
		button_checkallroute = (Button) findViewById(R.id.button_checkallroute);
		button_checkallroute.setOnClickListener(controlListener);
		LocationRegion.FONT_LANGUAGE = LocationRegion.NORMAL;
		banner_unopen_setstart = (Button) findViewById(R.id.button_unopen_setstart);
		banner_unopen_setstart.setOnClickListener(controlListener);
		banner_unopen_settarinsit = (Button) findViewById(R.id.button_unopen_settrainset);
		banner_unopen_settarinsit.setOnClickListener(controlListener);
		banner_unopen_settraget = (Button) findViewById(R.id.button_unopen_settraget);
		banner_unopen_settraget.setOnClickListener(controlListener);
		banner_unopen_setImage = (Button) findViewById(R.id.button_unopen_checkdetail);
		banner_unopen_setImage.setOnClickListener(controlListener);
		banner_open_setImage = (Button) findViewById(R.id.button_open_checkdetail);
		banner_open_setImage.setOnClickListener(controlListener);
		banner_label = (RelativeLayout) findViewById(R.id.banner_label);
		banner_label.setVisibility(View.INVISIBLE);
		banner_label_eat = (Button) findViewById(R.id.button_banner_label_eat);
		banner_label_eat.setOnClickListener(controlListener);
		banner_label_shop = (Button) findViewById(R.id.button_banner_label_shop);
		banner_label_shop.setOnClickListener(controlListener);
		banner_label_info = (Button) findViewById(R.id.button_banner_label_info);
		banner_label_info.setOnClickListener(controlListener);
		banner_label_enter = (Button) findViewById(R.id.button_banner_label_enter);
		banner_label_enter.setOnClickListener(controlListener);
		banner_label_zhiji = (Button) findViewById(R.id.button_banner_label_zhiji);
		banner_label_zhiji.setOnClickListener(controlListener);
		button_open_detail = (Button) findViewById(R.id.button_open_detail);
		button_open_detail.setOnClickListener(controlListener);
		button_unopen_detail = (Button) findViewById(R.id.button_unopen_detail);
		button_unopen_detail.setOnClickListener(controlListener);
		init_Service();
		// new a SAILS engine.
	...
	private void init_Service() {
		...
		// TODO Auto-generated method stub
		Intent intentTemp = new Intent(MapActivity.this, ChatService.class);
		startService(intentTemp);
		intentTemp = new Intent(MapActivity.this, FriendRequestService.class);
		startService(intentTemp);
	...
	void resultViewInit() {
		...
		if (intent.getStringArrayListExtra("shopsearchresult") != null) {
			...
			SAILSMap_search_result.setVisibility(View.INVISIBLE);
			relativelayout_allitemofmap.setVisibility(View.INVISIBLE);
	...
	void setSAEinitial() {
		Intent intent = getIntent();
		if (intent.getStringExtra("Extlr") != null) {
			final String label = intent.getStringExtra("Extlr");
			runOnUiThread(new Runnable() {
	...
	void routingInitial() {
		...
		new PathRoutingManager.OnRoutingUpdateListener() {
			...
			public void onTotalDistanceRefresh(int distance) {
				...
				distanceView.setText("路线长度: " + Integer.toString(distance)
						+ " (m)");
			...
			public void onReachNearestTransferDistanceRefresh(int distance,
				...
				case PathRoutingManager.SwitchFloorInfo.ELEVATOR:
					currentFloorDistanceView.setText("到最近的电梯: "
				...
				case PathRoutingManager.SwitchFloorInfo.DESTINATION:
					currentFloorDistanceView.setText("到终点: "
							+ Integer.toString(distance) + " (m)");
					break;
				}
				if (distance <= 5) {
			...
			public void onSwitchFloorInfoRefresh(
				...
				case PathRoutingManager.SwitchFloorInfo.DESTINATION:
					msgView.setText("导航: 前往" + sf.fromBelongsRegion.getName());
					break;
				}
	...
	View.OnClickListener controlListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			if (v == zoomin) {
				...
				method55();
				banner_label.setVisibility(View.INVISIBLE);
			} else if (v == button_open_detail) {
				SearchEntity SE = new SearchEntity(
						SearchEntity.SEARCH_SHOP_BY_LABEL, -1, -1,
						lrpointto.getName(), lrpointto.getName(),
						lrpointto.getName());
				banner_open.setVisibility(View.INVISIBLE);
				startSearch(SE);
			} else if (v == button_unopen_detail) {
				SearchEntity SE = new SearchEntity(
						SearchEntity.SEARCH_SHOP_BY_LABEL, -1, -1,
						lrpointto.getName(), lrpointto.getName(),
						lrpointto.getName());
